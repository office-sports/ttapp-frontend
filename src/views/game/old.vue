<template>
  <div class="mainContainer">
      ...
      <div>
        ...
        <div v-if="match.isFinished == 1">
          <div v-if="match.winnerId == 0">
            ...
            <div class="eloInfo">{{ match.homeElo }} ELO</div>
            <div class="eloInfo">
      ...
      <div>
        ...
        <div v-if="match.isFinished == 1">
          <div v-if="match.winnerId == 0">
            ...
            <div class="eloInfo">{{ match.awayElo }} ELO</div>
            <div class="eloInfo">
    ...
    <!--      &lt;!&ndash;      <input v-on:keyup.q="addPointLeft">Press me!</input>&ndash;&gt;-->
    <!--    </div>-->
        ...
        .post("/api/matches/save", {
          ...
          h5:
            typeof event.target.elements.home_set_5 === "undefined"
              ? ""
              : event.target.elements.home_set_5.value,
          a1:
          ...
          a5:
            typeof event.target.elements.away_set_5 === "undefined"
              ? ""
              : event.target.elements.away_set_5.value,
        })
        .then((res) => {
          this.errors = [];
          if (res.status === 200) {

<template>
  <div class="roundWrapper" v-if="this.tournament">
    <div class="txtHeader col-dark-green">
      ...
      <span class="padl10">Tournament {{ tournament.name }} full schedule</span>
    </div>
    <div class="mart20">
      <div class="txtSmall">
  ...
  mounted() {
    axios
      .all([
        ...
        axios.get("/api/tournaments/0/schedule/0"),
      ])
      .then(

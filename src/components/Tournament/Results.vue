  ...
  <div class="txtSmall">
      ...
      <table>
        ...
        >
          ...
          <td
            ...
            "
          >
            <router-link :to="'/player/' + match.homePlayerId + '/profile'">{{match.home_player_name}}</router-link>
          </td>
          <td class="txtc">-</td>
          <td
            v-bind:class="
          ...
          <td v-if="parseInt(match.has_points) > 0" style="color: #fff">
            ...
            ><i class="far fa-play-circle"></i></router-link>
          </td>
          <td v-else></td>
        </tr>
      </table>
    ...
    <div class="padt20" v-if="filteredMatches.length">
      ...
      <router-link
        ...
        >show full schedule</router-link
      >
    </div>
